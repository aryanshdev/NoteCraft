...
const NoteDisplay = ({
  ...
  return (
    <div
      ref={cardRef}
      id={id}
      className={`w-full h-52 rounded-md bg-${color}-600 bg-opacity-80 backdrop-brightness-200  hover:bg-opacity-100 hover:scale-[1.025] transition-all duration-300 flex flex-col justify-between text-white relative`}
    >
