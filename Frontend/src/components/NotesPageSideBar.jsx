  ...
  return (
    <>
      <div className="flex flex-row h-screen w-fit m-0 p-0 text-lg md:text-xl ">
        <header className=" bg-[#0a0a0a] h-auto fixed text-white text-black p-2 w-full md:hidden flex justify-between z-10">
          {/* SIDEBAR BUTTON */}
          <button
        ...
        >
          <div className=" md:relative bg-[#121212] h-full flex flex-col text-white text-black py-8 px-4  md:rounded-3xl bg-opacity-90 backdrop-brightness-75 w-[50vw] md:w-full gap-2 fixed">
