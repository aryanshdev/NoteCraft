...
function Index() {
  return (
    <>
      ...
      <section className="flex justify-center align-middle flex-col md:flex-row !w-screen h-screen overflow-hidden ">
        <div className="bg-gradient-to-br w-56 h-56 from-green-700 to-gray-700 rounded-full absolute bg-opacity-20 -z-20 top-0 left-1/2 blur-2xl overflow-hidden"></div> 
